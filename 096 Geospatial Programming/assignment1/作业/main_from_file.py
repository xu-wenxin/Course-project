...
class RCA(max_min):
    ...
    def line_judge(self, polygon_value, point):
        ...
        line_1_list = self.create_polygon_line(1, polygon_value)
        line_2_list = self.create_polygon_line(2, polygon_value)
        line_3_list = self.create_polygon_line(3, polygon_value)
    ...
    # The set of points of three adjacent line segments.
    def create_polygon_line(self, m, value):
        ...
        if m == 1:
            for i in range(len(value)-1):
                point_1 = value[i]
                point_2 = value[i+1]
                polygon_line_point.append([point_1, point_2])
            polygon_line_point.append([point_2, value[0]])
        ...
        # line 2
            ...
            for i in range(len(value)-2):
                ...
                polygon_line_point.append([point_1, point_2])
            polygon_line_point.append([point_2, value[0]])
            polygon_line_point.append([value[0], value[1]])
        ...
        # line 3
            ...
            polygon_line_point.append([point_2, value[0]])
            polygon_line_point.append([value[0], value[1]])
            polygon_line_point.append([value[1], value[2]])
...
# ouput csv file,can be save as class
